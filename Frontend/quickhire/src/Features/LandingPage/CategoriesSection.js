...
const useStyles = makeStyles(theme => ({
    ...
    categoriesContainer: {
        ...
        background: "linear-gradient(162deg, rgba(248, 248, 248, 1) 0%, rgb(190 220 235) 94%);",
        borderRadius: "10px"
    },
}));
...
const CategorySection = () => {
    ...
    return (
        <Container className={classes.categoriesContainer} maxWidth="false">
            <Typography variant="h4" className={classes.categoriesHeading} style={{marginTop: "18px"}}>
                Categories
            </Typography>
